...
{{% alert color="info"%}}
<b>Note:</b> This documentation covers [LDP v1.8.0](https://github.com/library-data-platform/ldp/tree/1.8.0) and [FOLIO Analytics v1.4.0](https://github.com/folio-org/folio-analytics/tree/release-1.4), which were released at approximately the same time as the FOLIO Morning Glory release.
{{% /alert %}}
