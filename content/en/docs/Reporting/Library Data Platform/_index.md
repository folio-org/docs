...
See the [Anonymization Guide](https://github.com/library-data-platform/ldp/blob/1.8.2/doc/Admin_Guide.md#anonymization) for information on how to activate and configure these features.
