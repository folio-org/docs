...
This documentation supports the Kiwi version of FOLIO. The Kiwi release has reached end-of-life on 2022-09-26, is no longer supported, has known security vulnerabilities, and should not be used in production. Use the Releases menu to select another version as needed.
{{% /alert %}}
