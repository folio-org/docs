...
{{% alert color="info"%}}
This documentation supports the Morning Glory version of FOLIO. The Morning Glory release has reached end-of-life on 2023-04-13, is no longer supported, has known security vulnerabilities, and should not be used in production. Use the Releases menu to select another version as needed.
{{% /alert %}}
