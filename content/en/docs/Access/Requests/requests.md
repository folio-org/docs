...
Hold shelf clearance reports are specific to individual service points. Therefore, you must be signed in to the service point you want to generate the report for. If there are no items matching the report’s criteria, the option appears grayed out.
